# Graph Report - smartIDS  (2026-07-21)

## Corpus Check
- 691 files · ~252,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5280 nodes · 8936 edges · 469 communities (338 shown, 131 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 960 edges (avg confidence: 0.67)
...
- ml/runtime (n=86)
- frontend/src/components/dashboard (n=70)
- backend/app/features/realtime (n=63)
- tests/unit (n=62)
- frontend/src/components/dashboard (n=59)
- backend/app/features/threats (n=54)
- backend/smoke (n=54)
- frontend (n=54)
- response engine (n=53)
- tests/integration (n=51)
- backend/app/email (n=49)
- frontend/src/lib/backend (n=49)
- backend/app/features/geolocation (n=48)
- frontend (n=42)
- frontend/src/components/ui (n=42)
- backend/app/features/auth (n=39)
- backend/app/features/alerts (n=38)
- frontend (n=36)
- backend/app/features/dashboard (n=35)
- ml/models (n=35)
- backend/app/features/auth (n=34)
- backend/app/features/api keys (n=34)
- backend/app/features/auth (n=33)
- backend/app/features/user sessions (n=32)
- backend/app/features/dashboard (n=31)
- backend/app/features/alerts (n=31)
- backend/app/features/auth (n=31)
- frontend/src/components/dashboard (n=31)
- tests/integration (n=31)
- backend/app/core (n=30)
- backend/app/features/user sessions (n=29)
- frontend (n=29)
- tests/unit (n=29)
- frontend/src/lib/db (n=29)
- backend (n=27)
- frontend/src/lib/backend (n=27)
- packet capture/forwarding (n=27)
- backend/app/features/sql injection (n=26)
- backend/app/features/auth (n=26)
- frontend/src/lib/backend (n=26)
- frontend/src/lib/backend (n=26)
- tests/unit (n=26)
- backend/app/common (n=24)
- backend/app/features/engine telemetry (n=24)
- backend/app/features/ids events (n=24)
- docs (n=24)
- ml/training (n=23)
- tests/unit (n=23)
- backend/app/features/auth (n=22)
- backend/app/features/sql injection (n=22)
- frontend (n=22)
- frontend/src/lib/realtime (n=22)
- backend/app/features/api keys (n=21)
- tests/unit (n=21)
- backend/app/features/block events (n=21)
- backend/app/features/dashboard (n=21)
- frontend/src/lib/backend (n=21)
- tests/unit (n=21)
- backend/app/features/api keys (n=20)
- backend/app/features/ip control state (n=20)
- traffic engine/session builder (n=20)
- frontend/src/app/api (n=20)
- frontend/src/components/dashboard (n=20)
- packet capture/telemetry (n=20)
- backend/app/features/blocked ips (n=19)
- backend/app/features/engine commands (n=19)
- backend/app/features/notifications (n=19)
- docs/superpowers (n=19)
- tests/unit (n=19)
- backend/app/common (n=18)
- backend/app/engine (n=18)
- backend/app/features/auth (n=18)
- backend/app/features/ids events (n=18)
- docs/superpowers (n=18)
- packet capture/utils (n=18)
- backend/app/detection (n=17)
- tests/unit (n=17)
- backend/app/features/ids events (n=16)
- tests/unit (n=16)
- response engine (n=16)
- packet capture/processor (n=16)
- response engine (n=16)
- tests/integration (n=16)
- tests/unit (n=16)
- tests/unit (n=16)
- backend/app/features/analytics rollups (n=15)
- backend/app/features/engine commands (n=15)
- backend/app/features/geolocation (n=15)
- backend/app/features/sessions (n=15)
- tests/unit (n=15)
- backend/app/common (n=14)
- backend/app/engine (n=14)
- backend/app/features/auth (n=14)
- backend/app/features/sessions (n=14)
- frontend/src/components/ui (n=14)
- tests/unit (n=14)
- tests/unit (n=14)
- backend/app/engine (n=13)
- backend/app/engine (n=13)
- backend/app/features/analytics rollups (n=13)
- ml/datasets (n=13)
- backend/app/common (n=12)
- backend/app/detection (n=11)
- backend/app/engine (n=11)
- backend/app/features/blocked ips (n=11)
- backend/app/features/sessions (n=11)
- feature engine (n=11)
- packet capture/sniffers (n=11)
- tests/unit (n=11)
- traffic engine/session builder (n=11)
- backend/app/features/auth (n=10)
- backend/app/features/sessions (n=10)
- backend/app/features/user sessions (n=10)
- backend/migrations (n=10)
- frontend (n=10)
- frontend/src/lib/backend (n=10)
- backend/app/common (n=9)
- tests/unit (n=9)
- backend/app/features/block events (n=9)
- backend/app/features/sessions (n=9)
- docs/superpowers (n=9)
- backend/smoke (n=9)
- response engine (n=9)
- tests/integration (n=9)
- backend/app/features/block events (n=8)
- docs/superpowers (n=8)
- docs/superpowers (n=8)
- tests/unit (n=8)
- tools (n=8)
- backend/app/db (n=7)
- backend/app/detection (n=7)
- tests/unit (n=7)
- backend/smoke (n=7)
- frontend/src/lib/actions (n=7)
- packet capture/forwarding (n=7)
- tests/integration (n=7)
- backend/app/features/api keys (n=6)
- backend/app/features/reporting contract (n=6)
- config (n=6)
- tests/integration (n=6)
- tests/integration (n=6)
- tests/integration (n=6)
- tests/unit (n=6)
- tests/unit (n=6)
- (root) (n=5)
- backend (n=5)
- backend/app/features/alerts (n=5)
- backend/app/features/api keys (n=5)
- backend/app/features/blocked ips (n=5)
- backend/app/features/dashboard (n=5)
- backend/app/features/ids events (n=5)
- backend/app/features/sessions (n=5)
- backend/app/features/sessions (n=5)
- backend/app/features/sql injection (n=5)
- backend/smoke (n=5)
- tests/integration (n=5)
- tests/unit (n=5)
- docs (n=4)
- backend/app/features/engine commands (n=4)
- backend/app/features/engine telemetry (n=4)
- docs (n=4)
- frontend (n=4)
- frontend/src/types (n=4)
- backend (n=3)
- docs (n=3)
- docs (n=3)
- backend (n=3)
- backend/templates (n=3)
- replay (n=3)
- script (n=3)
- tests/integration (n=3)
- tests/unit (n=3)
- tools (n=3)
- (root) (n=2)
- (root) (n=2)
- backend/app/features/alerts (n=2)
- backend/app/features/analytics rollups (n=2)
- backend/app/features/block events (n=2)
- backend/app/features/blocked ips (n=2)
- backend/app/features/dashboard (n=2)
- backend/app/features/engine commands (n=2)
- backend/app/features/ids events (n=2)
- backend/app/features/ip control state (n=2)
- backend/app/features/notifications (n=2)
- backend/app/features/realtime (n=2)
- backend/app/features/reporting contract (n=2)
- backend/app/features/sessions (n=2)
- backend/app/features/sql injection (n=2)
- backend/app/features/threats (n=2)
- backend/app/worker (n=2)
- backend (n=2)
- backend (n=2)
- backend (n=2)
- backend (n=2)
...
- use-realtime-connection-state.ts
- test_secondary_model_dispatch.py
- Engine
- API Reference
- Data Patterns
...
- CompletedFlowPredictor
- contracts.py
- get_internal_auth_redis
- APIKeyService
- SQLInjectionEvent
...
- .test_enqueue_command_pushes_over_ws_when_newly_created
- create_api_key
...
- Sections
- FakeSessionService
- InvalidIDSEventPayloadException
- list_threats
...
- get_engine_service
- RegisterInitRequest
- api_smoke_dashboard_metrics_ws.py
...
- _template.md
- .connect
- FakeAnalyticsRollupService
- FakeDashboardService
- engine_ws_manager.py
- .force_disconnect
...
6. `Settings` - 49 edges
7. `PacketProcessor` - 45 edges
8. `getForwardedCookieHeader()` - 43 edges
...
- `Graphify Skill Trigger (.claude/CLAUDE.md)` --semantically_similar_to--> `Graphify Query Rules (root CLAUDE.md)`  [INFERRED] [semantically similar]
  .claude/CLAUDE.md → CLAUDE.md
- `Passive Userland IDS Project Identity` --semantically_similar_to--> `SmartIDS Root README Overview`  [INFERRED] [semantically similar]
  AGENTS.md → README.md
...
- **SQL Injection Feature Module Cluster** — backend_agents_sql_injection_merge_context, backend_plan_phase_sql_injection_feature_module, backend_app_features_sql_injection_contract_notes_sqldecisionrequest, backend_app_features_sql_injection_contract_notes_sqldecisionresponse [INFERRED 0.85]
- **Local Infrastructure Docker Compose Stack** — backend_docker_compose_postgres_service, backend_docker_compose_redis_service, backend_docker_compose_pgadmin_service, backend_docker_compose_flower_service [EXTRACTED 1.00]
- **Transactional Email Template System** — backend_templates_emails_base_layout, backend_templates_emails_oauth_account_notice_template, backend_templates_emails_verify_email_template [EXTRACTED 1.00]
...
## Communities (469 total, 131 thin omitted)

### Community 0 - "ml/runtime (n=86)"
Cohesion: 0.13
Nodes (8): CompletedFlowPredictor, Path, Builds the feature frame once and reuses it for both the         synchronous pri, DummyLabelEncoder, DummyRuntimeModel, Path, RuntimeArtifactValidationTest, _write_checksum()

### Community 1 - "frontend/src/components/dashboard (n=70)"
Cohesion: 0.08
Nodes (47): ActionToast(), ActionToastProps, BlockedIpRow, BlockedIpsLiveTable(), Props, RealtimeBlockedIpRow, DashboardMetricsLiveIndicator(), GlobalThreatToast() (+39 more)

### Community 2 - "backend/app/features/realtime (n=63)"
Cohesion: 0.08
Nodes (32): Realtime-specific exceptions., Raised when realtime payload is not safe for frontend broadcast., RealtimePayloadValidationException, broadcast_realtime_alert(), broadcast_realtime_blocked_ip(), broadcast_realtime_dashboard_metrics(), broadcast_realtime_session(), Realtime routes for websocket clients and broadcast hooks. (+24 more)

### Community 3 - "tests/unit (n=62)"
Cohesion: 0.27
...
Cohesion: 0.11
Nodes (28): AnalyticsPage(), RANGE_OPTIONS, maskIp(), TrafficPage(), OverviewCharts(), OverviewChartsProps, MetricProps, OverviewMetricsGrid() (+20 more)
...
Cohesion: 0.05
Nodes (59): _assert_success_envelope(), main(), API smoke check for alerts/threats listing and filters.  Usage:   python backend, run(), main(), _post_json(), Smoke test for backend block-events upsert flow., _assert_success_envelope() (+51 more)

### Community 7 - "frontend (n=54)"
Cohesion: 0.06
...
Cohesion: 0.20
Nodes (5): FirewallAdapter, ABC, create_firewall_adapter(), LinuxFirewallAdapter, WindowsFirewallAdapter
...
Cohesion: 0.06
Nodes (39): get_settings(), Application configuration loaded from environment variables.  Uses pydantic-sett, Return cached application settings singleton., EmailDeliveryError, EmailDeliveryPermanentError, Exception, Email delivery exceptions.  Used to separate permanent provider/configuration pr, Base class for outbound email delivery failures. (+31 more)

### Community 11 - "frontend/src/lib/backend (n=49)"
Cohesion: 0.10
Nodes (41): HealthPage(), OverviewPage(), ApiKey, fetchApiKeysFromBackend(), DashboardDistributionPoint, DashboardModelMetrics, DashboardNetworkThreatRollupPoint, DashboardSummary (+33 more)
...
Cohesion: 0.07
Nodes (27): babel-plugin-react-compiler, drizzle-kit, eslint, eslint-config-next, devDependencies, babel-plugin-react-compiler, drizzle-kit, eslint (+19 more)

### Community 14 - "frontend/src/components/ui (n=42)"
Cohesion: 0.05
Nodes (61): Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, AlertDialogMedia(), AlertDialogOverlay(), CardAction() (+53 more)
...
Cohesion: 0.08
Nodes (27): get_alert_service(), AsyncSession, FastAPI dependencies for alerts feature., Provide an AlertService instance for the current request., list_alerts(), datetime, User, FastAPI routes for alert operations. (+19 more)

### Community 17 - "frontend (n=36)"
Cohesion: 0.06
Nodes (35): compilerOptions, allowJs, baseUrl, esModuleInterop, incremental, isolatedModules, jsx, lib (+27 more)

### Community 18 - "backend/app/features/dashboard (n=35)"
Cohesion: 0.10
Nodes (34): get_attack_distribution(), get_audit_history(), get_block_actions_over_time(), get_dashboard_summary(), get_incident_detail(), get_incident_report(), get_incidents(), get_model_metrics() (+26 more)

### Community 19 - "ml/models (n=35)"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (24): DatabaseException, Database-level error — maps to HTTP 500., Alert, Database model for alerts., Deduplicated alert record derived from IDS events., AlertRepository, AsyncSession, Encapsulates database operations for alerts. (+16 more)

### Community 25 - "backend/app/features/alerts (n=31)"
Cohesion: 0.21
Nodes (10): PaginatedThreatsResponse, BaseModel, Schemas for threat report endpoints., Threat report response model., Paginated threat listing payload., Response payload for threat response action mutation., Filter options for threat report listing., ThreatFilters (+2 more)

### Community 26 - "backend/app/features/auth (n=31)"
Cohesion: 0.06
Nodes (27): EmailAlreadyExistsException, EmailNotVerifiedException, EmailVerificationException, InvalidCredentialsException, OAuthAuthenticationException, OAuthProviderNotConfiguredException, PasswordResetException, Any (+19 more)

### Community 27 - "frontend/src/components/dashboard (n=31)"
Cohesion: 0.10
Nodes (14): Compares list-based packet-length stats against the incremental         (Welford, Bounded, disk-backed spill buffer for a single forwarder.  Used by ``BackgroundP, _persist_result(), _post_register_init(), Orchestrates browser-based engine registration (Part A Phase 1).  Steps, per doc, Runs the full registration flow, blocking until completion or timeout.      Retu, run_registration(), Temporary local loopback HTTP server for browser-based engine registration.  Par (+6 more)
...
Cohesion: 0.22
Nodes (11): extractStrings(), POST(), scanFields(), SQL_INJECTION_PATTERNS, SQLInjectionResponse, validateApiKey(), requestBackendJson(), SqlInjectionDecisionPayload (+3 more)

### Community 34 - "backend (n=27)"
Cohesion: 0.16
...
Cohesion: 0.07
Nodes (38): ApiKeysPage(), ApiKeysManager(), addApiKey(), editApiKey(), listApiKeysAction(), removeApiKey(), ApiKeyCreateData, ApiKeyListData (+30 more)

### Community 36 - "packet capture/forwarding (n=27)"
Cohesion: 0.10
Nodes (13): InternalRequestSigner, path_with_query(), Engine-side HMAC request signing for internal-service-auth-protected routes.  Mi, Derive ``path`` (plus ``"?"+query`` if present) from a full URL.      Matches th, FastAPIAlertForwarder, FastAPIBlockEventForwarder, FastAPIEngineTelemetryForwarder, FastAPIIDSEventForwarder (+5 more)
...
Cohesion: 0.11
Nodes (12): OAuthAccount, SQLAlchemy models for authentication., Application user with optional email/password credentials., Links a user to an external OAuth provider identity., User, OAuthAccountRepository, AsyncSession, User (+4 more)

### Community 39 - "frontend/src/lib/backend (n=26)"
Cohesion: 0.60
Nodes (4): markAllRead(), markOneRead(), markAllNotificationsReadOnBackend(), markNotificationReadOnBackend()

### Community 40 - "frontend/src/lib/backend (n=26)"
Cohesion: 0.16
Nodes (18): GET(), GET(), LoginPage(), fetchLogsFromBackend(), FetchLogsParams, toArray(), buildJsonHeaders(), getBackendRestBase() (+10 more)
...
Cohesion: 0.09
Nodes (22): get_history(), get_engine_telemetry_service(), AsyncSession, Dependencies for IDS engine telemetry., ingest_engine_telemetry(), Request, Routes for IDS engine telemetry ingestion., EngineTelemetryIngestRequest (+14 more)
...
Cohesion: 0.11
Nodes (16): BlockedIpSearchParams, ThreatSearchParams, BlockedIpActionPanel(), BlockedIpsFiltersForm(), ApprovalState, EngineRegistrationApproval(), Props, FilterEmptyAction() (+8 more)

### Community 46 - "ml/training (n=23)"
Cohesion: 0.15
Nodes (4): DiskSpillStore, Same decoding as ``_decode_line`` but without re-logging -- used         by ``di, Removes the oldest ``count`` *valid* entries (i.e. the same items         ``peek, DiskSpillStoreTest
...
Cohesion: 0.13
Nodes (6): EngineLocalConfig, Persistent local storage for a browser-approved engine credential.  Mirrors ``re, Convenience for callers that just want "is there a saved config"., Chooses the engine's internal-auth signer, in priority order:          1. A prev, SnifferService, LiveSniffer

### Community 49 - "backend/app/features/sql injection (n=22)"
Cohesion: 0.10
Nodes (16): get_sql_injection_service(), AsyncSession, FastAPI dependencies for SQL injection feature., Provide SQLInjectionService instance for current request., decide_sql_request(), Routes for SQL injection decision flow., Return allow/block decision and mapped HTTP status., BaseModel (+8 more)

### Community 50 - "frontend (n=22)"
Cohesion: 0.09
Nodes (21): aliases, components, hooks, lib, ui, utils, iconLibrary, menuAccent (+13 more)

### Community 52 - "backend/app/features/api keys (n=21)"
Cohesion: 0.12
...
Cohesion: 0.17
Nodes (6): BlockEvent, Database model for block/watchlist events., BlockEventRepository, AsyncSession, BlockedIPRepository, AsyncSession
...
Cohesion: 0.13
Nodes (26): GET(), mapBackendDetail(), mapFallbackDetail(), mapBackendThreat(), ThreatReportsPage(), toQuery(), respondSessionAction(), respondThreatAction() (+18 more)
...
Cohesion: 0.20
Nodes (6): IPControlState, Database model for current controlled-IP state., Current authoritative state for a controlled IP., IPControlStateRepository, AsyncSession, Data-access helpers for current controlled-IP state.

### Community 60 - "traffic engine/session builder (n=20)"
Cohesion: 0.04
...
Cohesion: 0.27
Nodes (7): DashboardEntrance(), DashboardEntranceProps, DashboardMotionContext, DashboardMotionMode, DashboardMotionProvider(), useDashboardMotionMode(), shouldAnimateDashboardEntrance()

### Community 63 - "packet capture/telemetry (n=20)"
Cohesion: 0.09
Nodes (10): _idle_timeout_case(), main(), _max_duration_case(), Packet, Targeted smoke for session finalization reasons.  Validates that SessionBuilder, SessionFeatureExtractor, EngineTelemetryCollectorTest, RuntimeSessionFeatureTest (+2 more)

### Community 64 - "backend/app/features/blocked ips (n=19)"
Cohesion: 0.22
Nodes (16): GET(), mapBackendSessionDetail(), mapBackendSession(), SessionLogsPage(), SessionSearchParams, SessionsFiltersForm(), fetchSessionDetailFromBackend(), fetchSessionsFromBackend() (+8 more)

### Community 65 - "backend/app/features/engine commands (n=19)"
Cohesion: 0.11
Nodes (15): acknowledge_engine_command(), create_engine_command(), poll_engine_commands(), Routes for IDS engine command polling and acknowledgements., EngineCommandAckRequest, EngineCommandCreateRequest, EngineCommandPollResponse, EngineCommandResponse (+7 more)

### Community 66 - "backend/app/features/notifications (n=19)"
Cohesion: 0.12
Nodes (13): get_notification_service(), AsyncSession, FastAPI dependencies for notifications., Provide NotificationService instance for the current request., mark_all_notifications_read(), mark_notification_read(), User, Routes for notification read-state updates. (+5 more)

### Community 67 - "docs/superpowers (n=19)"
Cohesion: 0.04
...
Cohesion: 0.10
Nodes (15): NotFoundException, Any, Base exception hierarchy for the application.  All application-level exceptions, Resource not found — maps to HTTP 404., A required backing service (e.g. Redis) is unreachable — maps to HTTP 503., ServiceUnavailableException, AlertNotFoundException, Alert-specific exceptions. (+7 more)
...
Cohesion: 0.12
Nodes (16): hash_password(), Password hashing utilities using Argon2id., Hash a plaintext password with Argon2id., Verify a plaintext password against a stored Argon2 hash., verify_password(), generate_reset_token(), Redis, URLSafeTimedSerializer (+8 more)

### Community 72 - "backend/app/features/ids events (n=18)"
Cohesion: 0.13
Nodes (9): IDSEvent, Database model for IDS events., Normalized IDS event persisted for query and alerting flows., IDSEventRepository, AsyncSession, Data-access layer for IDS events., Encapsulates database operations for IDS events., List IDS events with pagination and optional filters. (+1 more)
...
Cohesion: 0.18
Nodes (11): flatten_json(), Any, detect_threats(), get_detection_orchestrator(), DetectionRequest, DetectionResponse, NormalizedRequest, BaseModel (+3 more)

### Community 76 - "tests/unit (n=17)"
Cohesion: 0.22
Nodes (4): BlockEventRealtimePersistenceTest, FakeBlockEvent, FakeIPControlStateService, FakeRealtimeService
...
Cohesion: 0.18
Nodes (15): fallbackActivity(), GET(), mapActivity(), BlockedIpsPage(), mapBackendBlockedIp(), BlockedIpActivityResponse, BlockedIpActivityRow, BlockedIpApiRow (+7 more)

### Community 80 - "packet capture/processor (n=16)"
Cohesion: 0.25
Nodes (3): PacketProcessor, Aggregate secondary-model dispatcher queue stats for both predictors.          E, SessionKey
...
Cohesion: 0.09
Nodes (7): DashboardMetricsFlowTest, FakeBlockedIPRepository, FakeDashboardService, FakeEngineCommandService, FakeNetworkSession, FakeRealtimeService, FakeSessionRepository

### Community 83 - "tests/unit (n=16)"
Cohesion: 0.13
Nodes (5): FakeAlertService, FakeAnalyticsRollupService, FakeDashboardService, FakeIDSEvent, FakeIDSEventRepository

### Community 84 - "tests/unit (n=16)"
Cohesion: 0.17
Nodes (6): EngineWSConnectionManager, Tracks active engine websocket connection(s) and pushes commands., EngineWSConnectionManagerTest, FakeWebSocket, Regression check: adding the engine-scoped lookup must not break         the exi, Same regression check as above, for push_config_update.

### Community 85 - "backend/app/features/analytics rollups (n=15)"
Cohesion: 0.17
Nodes (7): AnalyticsRollupService, AsyncSession, datetime, Business logic for durable analytics rollup updates., Maintains compact long-term analytics buckets from backend ingest flows., AsyncSession, AsyncSession

### Community 86 - "backend/app/features/engine commands (n=15)"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (6): IpLocation, SQLAlchemy model for persisted IP location records., Resolved geolocation record for a user's session IP address.      One record is, Persist a new IpLocation record.          Uses INSERT … ON CONFLICT DO NOTHING s, Return the location record for *session_id*, or None if absent., Return all location records that share *ip*, ordered most recent first.

### Community 88 - "backend/app/features/sessions (n=15)"
Cohesion: 0.09
Nodes (16): NetworkSession, Database model for network sessions., Network flow/session observed by the IDS background engine., NetworkSessionRepository, AsyncSession, Data-access layer for network sessions., Encapsulates database operations for network sessions., NetworkSessionUpsertRequest (+8 more)
...
Cohesion: 0.20
Nodes (9): Classification, ABC, Enum, Abstract base class for all detection rules., Evaluates the input and returns a RuleResult., A concrete rule that uses pre-compiled regular expressions., RegexRule, Rule (+1 more)

### Community 92 - "backend/app/features/auth (n=14)"
Cohesion: 0.25
...
Cohesion: 0.24
Nodes (4): EngineTelemetryCollector, Queue, _safe_qsize(), _session_exchange()

### Community 97 - "backend/app/engine (n=13)"
Cohesion: 0.22
Nodes (6): PathTraversalDetector, Any, Stage 1: Input Normalization, Stage 6: Explainability Engine JSON Formatting Output, Stage 2: Decoder Pipeline (Iterative Decoding until Stable State), Stage 3: Canonicalization

### Community 98 - "backend/app/engine (n=13)"
Cohesion: 0.21
...
Cohesion: 0.19
Nodes (7): NetworkThreatRollup, Database models for long-term analytics rollups., Bucketed long-term network activity versus threat-rate analytics., AnalyticsRollupRepository, AsyncSession, datetime, Data-access helpers for long-term analytics rollups.

### Community 100 - "ml/datasets (n=13)"
Cohesion: 0.18
Nodes (10): Push a newly-created command to any connected engine(s).          Best-effort: t, Push a config update to any connected engine(s).          Mirrors ``push_command, EngineWSAuthPayload, EngineWSCommandAckPayload, EngineWSEnvelope, BaseModel, Schemas and constants for the engine<->backend command WebSocket.  This is a sep, Payload of the first (``type: "auth"``) frame the engine must send. (+2 more)

### Community 101 - "backend/app/common (n=12)"
Cohesion: 0.08
Nodes (24): CamelModel, ErrorResponse, MetaSchema, PaginatedData, BaseModel, Shared Pydantic response schemas for the unified API response format.  Every API, Metadata included in every API response., Unified success response wrapper. (+16 more)

### Community 102 - "backend/app/detection (n=11)"
Cohesion: 0.24
Nodes (4): CmdInjectionAdapter, PathTraversalAdapter, SqlInjectionAdapter, XSSAdapter

### Community 103 - "backend/app/engine (n=11)"
Cohesion: 0.24
...
Cohesion: 0.10
Nodes (20): get_ip_activity_history(), list_blocked_ips(), manual_block_ip(), manual_unblock_ip(), move_ip_to_watchlist(), User, Routes for blocked/watchlisted IP management., List blocked/watchlisted IP summaries. (+12 more)

### Community 105 - "backend/app/features/sessions (n=11)"
Cohesion: 0.10
Nodes (27): get_network_session(), list_network_sessions(), datetime, User, FastAPI routes for network sessions., Apply analyst response action for one session row., List network sessions with pagination and optional filters., Get one network session by external session_id. (+19 more)

### Community 106 - "feature engine (n=11)"
Cohesion: 0.53
Nodes (8): safe_iat_stats(), safe_max(), safe_mean(), safe_min(), safe_rate(), safe_std(), safe_variance(), sanitize_feature_dict()
...
Cohesion: 0.24
Nodes (9): do_run_migrations(), Alembic migration environment configuration.  Uses the async engine from the app, Run migrations in 'offline' mode.      Generates SQL scripts without connecting, Run migrations using the provided connection., Run migrations in 'online' mode using an async engine., Entry point for online migrations — delegates to async runner., run_async_migrations(), run_migrations_offline() (+1 more)

### Community 114 - "frontend (n=10)"
Cohesion: 0.20
...
Cohesion: 0.27
Nodes (12): _authenticate(), engine_ws(), _handle_command_ack(), Redis, WebSocket, Engine<->backend command WebSocket endpoint (Workstream 6c).  Separate from the, Read and verify the first frame.      Returns ``(True, engine)`` iff auth succee, Apply a ``command_ack`` frame using a short-lived DB session.      Uses its own (+4 more)

### Community 118 - "backend/app/features/block events (n=9)"
Cohesion: 0.38
Nodes (3): BlockEventService, Service for block/watchlist event upsert flow., Push block-actions-over-time/network-threat-rollups updates.          Debounced

### Community 119 - "backend/app/features/sessions (n=9)"
Cohesion: 0.06
Nodes (25): EngineNotActiveException, EngineNotFoundException, Raised when an engine does not exist or is not owned by the user., Raised when an operation requires an active engine but it is revoked., Engine, A registered IDS engine instance, holding its own per-engine HMAC secret.      R, Unauthenticated: an engine announces a pending registration attempt., register_init() (+17 more)
...
Cohesion: 0.28
Nodes (4): FakeAlertService, FakeRealtimeService, Smoke test for IDS ingest -> alert upsert -> realtime broadcast flow., run_smoke()

### Community 122 - "response engine (n=9)"
Cohesion: 0.09
Nodes (36): EnginesPage(), EngineConnectivity, EnginesManager(), formatDate(), formatDateTime(), SessionLocation, UserModalProps, UserSession (+28 more)
...
Cohesion: 0.08
Nodes (25): 1. User session (browser clients), 2. Internal service token (IDS runtime → backend), 3. API keys, API Layer, Architecture, Authentication, Backend Architecture, Backend (`backend/requirements.txt`) (+17 more)

### Community 126 - "docs/superpowers (n=8)"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 127 - "tests/unit (n=8)"
Cohesion: 0.08
Nodes (24): Backend, Cache / Queue, Code Quality, Common Development Tasks, Context Loading, Database, Definition of Done, Development Commands (+16 more)

### Community 128 - "tools (n=8)"
Cohesion: 0.64
Nodes (7): main(), replay_bruteforce_like(), replay_mixed(), replay_normal(), replay_port_sweep(), _send_tcp_packet(), _send_udp_packet()

### Community 129 - "backend/app/db (n=7)"
Cohesion: 0.29
Nodes (5): get_db_session(), AsyncSession, Async database engine and session factory., main(), Smoke test for backend-local database modules.

### Community 130 - "backend/app/detection (n=7)"
Cohesion: 0.33
Nodes (4): DetectorAdapter, EngineRegistry, Protocol, Executes the detection logic on the given string payload.         Returns a tupl

### Community 131 - "tests/unit (n=7)"
Cohesion: 0.06
Nodes (32): Basic Types, Blog with Full Relations, Complex Examples, Custom Extras, Defining Relations, Drizzle Relations & Relational Queries, Example Comparison, Feed Query (+24 more)

### Community 132 - "backend/smoke (n=7)"
Cohesion: 0.09
Nodes (22): `alerts` — `app/features/alerts/models.py`, `api_keys`, `block_events` — `app/features/block_events/models.py`, Database, Engine, `engine_commands` — `app/features/engine_commands/models.py`, `engine_telemetry_snapshots` — `app/features/engine_telemetry/models.py`, ER Overview (+14 more)

### Community 133 - "frontend/src/lib/actions (n=7)"
Cohesion: 0.09
...
### Community 136 - "backend/app/features/api keys (n=6)"
Cohesion: 0.33
Nodes (3): APIKeyLimitExceededException, API-key–specific exceptions., Raised when a user exceeds the maximum number of API keys.

### Community 137 - "backend/app/features/reporting contract (n=6)"
Cohesion: 0.47
Nodes (5): BlockEventContract, BaseModel, Canonical IDS reporting contracts used across backend features., SessionUpdateContract, ThreatAlertContract

### Community 138 - "config (n=6)"
Cohesion: 0.33
...
### Community 142 - "tests/unit (n=6)"
Cohesion: 0.13
Nodes (5): FakeNetworkSession, FakeSessionRepository, FakeTelemetryRepository, FakeTelemetrySnapshot, LiveDashboardServicesTest

### Community 144 - "(root) (n=5)"
Cohesion: 0.67
Nodes (3): Passive Userland IDS Project Identity, Legacy venv/pip-freeze/run Workflow Notes, SmartIDS Root README Overview

### Community 145 - "backend (n=5)"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (10): Any, DataFrame, Same as ``predict_primary`` but takes an already-built frame.          Lets a ca, RuntimeModelBundle, RuntimeModelStack, DummyLabelEncoder, DummyModel, _make_bundle() (+2 more)

### Community 147 - "backend/app/features/api keys (n=5)"
Cohesion: 0.40
Nodes (4): get_api_key_service(), AsyncSession, FastAPI dependencies for the API keys feature., Provide an APIKeyService instance for the current request.

### Community 148 - "backend/app/features/blocked ips (n=5)"
Cohesion: 0.40
Nodes (4): get_blocked_ip_service(), AsyncSession, Dependencies for blocked IP feature., Provide BlockedIPService for current request.

### Community 149 - "backend/app/features/dashboard (n=5)"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (26): Avoid N+1 Queries, Batch Operations, Bulk Insert, Bulk Operations, Bulk Update with CASE, Bulk Upsert, Cache Invalidation, Caching Strategies (+18 more)
...
Cohesion: 0.40
Nodes (3): SQL injection feature exceptions., Raised when SQL injection payload shape is invalid., SQLInjectionPayloadValidationException

### Community 154 - "backend/smoke (n=5)"
Cohesion: 0.60
Nodes (4): main(), Path, Run all backend smoke checks in sequence.  Usage:   python backend/smoke/run_all, run_script()

### Community 155 - "tests/integration (n=5)"
Cohesion: 0.10
Nodes (21): Anti-Patterns (CRITICAL), Basic Table with Timestamps, Directory Structure, Drizzle ORM, Essential Commands, Filtered Query, Foreign Key with Index, "How do I model this relationship?" (+13 more)

### Community 157 - "docs (n=4)"
Cohesion: 0.22
Nodes (8): SmartIDS Agent Notes, Backend Implementation Checklist, Change Log (Major), Completed, In Progress, Planned, Temporary Smoke Scaffolding, Working Rules

### Community 158 - "backend/app/features/engine commands (n=4)"
Cohesion: 0.50
...
Cohesion: 0.17
Nodes (17): compute_sha256(), Path, Pre-load integrity verification for ML runtime artifacts.  Computes and verifies, Return the hex-encoded SHA-256 digest of the file at ``path``., Verify that ``path`` matches the checksum recorded at ``checksum_path``.      Ra, verify_artifact_checksum(), _checksum_path(), load_runtime_model_artifacts() (+9 more)
...
Cohesion: 0.15
Nodes (7): EngineLimitExceededException, PendingRegistrationNotFoundException, Engine-specific exceptions., Raised when a user exceeds the maximum number of registered engines., Raised when a registration_id has no pending entry (never existed, expired, or a, PendingRegistrationResponse, Session-authenticated: what the approval page shows the user.
...
Cohesion: 0.31
Nodes (3): Persistent engine<->backend WebSocket client (Workstream 6c).  Replaces the 1.5s, BackendCommandPoller, BackendCommandPollerTest

### Community 185 - "tests/integration (n=3)"
Cohesion: 0.22
Nodes (5): DashboardMetricsWebSocketTest, FakeAsyncRedis, Build valid x-smartids-* signing headers, mirroring the production     signing-s, Minimal in-memory stand-in for redis.asyncio.Redis's SET NX EX usage., sign_request()

### Community 206 - "backend (n=2)"
Cohesion: 0.12
...
### Community 216 - "replay (n=2)"
Cohesion: 0.49
Nodes (3): _dataset_row(), Path, XGBoostCICIDS2018WorkflowTest

### Community 223 - "backend (n=1)"
Cohesion: 0.10
Nodes (20): Aggregations, Connection Setup, Delete, drizzle.config.ts, drizzle-kit Commands, Drizzle + PostgreSQL Quick Reference, Error Codes, Insert (+12 more)
...
Cohesion: 0.08
Nodes (27): clear_session_cookie(), _extract_session_token(), get_auth_service(), get_current_auth_session(), get_current_user(), AsyncSession, AuthSession, Request (+19 more)

### Community 245 - "docs (n=1)"
Cohesion: 0.11
Nodes (18): Additive, opt-in runtime integrations, Architectural Decisions, Bounded in-memory/file-backed state for IP activity, Engine↔backend WebSocket is a latency optimization, not a replacement for the durable command queue, Engine-command dedupe is process-local, not durable, Fail-fast model loading, Frontend migrated off direct database writes, HMAC-signed shared secret, not bare-token comparison (+10 more)

### Community 246 - "docs (n=1)"
Cohesion: 0.11
...
### Community 247 - "docs (n=1)"
Cohesion: 0.16
Nodes (11): EngineHeaderInternalAuthTest, InternalServiceAuthTest, json_dumps(), Build valid x-smartids-* signing headers, mirroring the production     signing-s, Covers the x-smartids-engine-id per-engine HMAC secret resolution path     added, Proves the engine's own secret is used as the HMAC key — not the         global, Covers the credential-rotation dual-secret grace window: a request         signe, The new secret must keep working too, alongside the grace-window         previou (+3 more)

### Community 269 - "Parallel & Intercepting Routes"
Cohesion: 0.11
...
### Community 270 - "use-realtime-connection-state.ts"
Cohesion: 0.07
Nodes (27): DashboardLayout(), buildCurrentUrl(), EngineRegisterPage(), RegisterSearchParams, HomePage(), links, MobileSidebarMenu(), getBadgeClass() (+19 more)
...
Cohesion: 0.15
Nodes (5): EngineRepository, AsyncSession, Data-access layer for Engine entities., Encapsulates database operations for Engine entities., Unscoped by user — used by the internal-auth hot path to resolve a secret.
...
### Community 275 - "5. Re-render Optimization"
Cohesion: 0.12
Nodes (16): 5.10 Subscribe to Derived State, 5.11 Use Functional setState Updates, 5.12 Use Lazy State Initialization, 5.13 Use Transitions for Non-Urgent Updates, 5.14 Use useDeferredValue for Expensive Derived Renders, 5.15 Use useRef for Transient Values, 5.1 Calculate Derived State During Rendering, 5.2 Defer State Reads to Usage Point (+8 more)

### Community 276 - "router.py"
Cohesion: 0.10
Nodes (27): approve_registration(), get_pending_registration(), list_engines(), User, FastAPI routes for browser-based IDS engine registration and management.  Regist, Rename an engine. The credential itself can never be changed here., Revoke an engine's credential. This is a soft revoke, not a hard delete., Rotate an engine's credential, issuing a new secret.      The old secret keeps v (+19 more)
...
### Community 280 - "7. JavaScript Performance"
Cohesion: 0.13
...
### Community 281 - "Quick Reference"
Cohesion: 0.13
Nodes (14): 1. Eliminating Waterfalls (CRITICAL), 2. Bundle Size Optimization (CRITICAL), 3. Server-Side Performance (HIGH), 4. Client-Side Data Fetching (MEDIUM-HIGH), 5. Re-render Optimization (MEDIUM), 6. Rendering Performance (MEDIUM), 7. JavaScript Performance (LOW-MEDIUM), 8. Advanced Patterns (LOW) (+6 more)

### Community 282 - "EngineTelemetryIngestTest"
Cohesion: 0.20
Nodes (6): EngineTelemetryIngestTest, FakeAsyncRedis, FakeEngineTelemetryService, Build valid x-smartids-* signing headers, mirroring the production     signing-s, Minimal in-memory stand-in for redis.asyncio.Redis's SET NX EX usage., sign_request()

### Community 283 - "EngineWSRouterTest"
Cohesion: 0.19
Nodes (4): EngineWSCredentialRotationAuthTest, EngineWSRouterTest, Covers the dual-secret (current + previous) auth path added to     _authenticate, sign_ws_auth()

### Community 284 - "Dashboard (`/api/v1/dashboard`) — `app/features/dashboard/`"
Cohesion: 0.14
Nodes (14): Dashboard (`/api/v1/dashboard`) — `app/features/dashboard/`, `GET /dashboard/attack-distribution`, `GET /dashboard/audit`, `GET /dashboard/block-actions-over-time`, `GET /dashboard/history`, `GET /dashboard/incidents`, `GET /dashboard/incidents/{incident_id}`, `GET /dashboard/incidents/{incident_id}/report` (+6 more)

### Community 285 - "Find Skills"
Cohesion: 0.14
Nodes (13): Common Skill Categories, Find Skills, How to Help Users Find Skills, Step 1: Understand What They Need, Step 2: Check the Leaderboard First, Step 3: Search for Skills, Step 4: Verify Quality Before Recommending, Step 5: Present Options to the User (+5 more)

### Community 286 - "SKILL.md"
Cohesion: 0.14
...
### Community 288 - "Customization & Theming"
Cohesion: 0.14
...
### Community 290 - "Component Composition"
Cohesion: 0.15
...
Cohesion: 0.25
Nodes (6): dto_to_ip_location(), Convert a LocationDto to an IpLocation ORM model., AsyncGeolocationService, Asynchronous geolocation service for FastAPI contexts., Geolocation service for Celery workers that uses a synchronous provider.     Exp, SyncGeolocationService

### Community 293 - "get_internal_auth_redis"
Cohesion: 0.20
Nodes (7): get_internal_auth_redis(), get_internal_auth_redis_pool(), Redis, Async Redis client for hot request-path use.  Unlike the synchronous ``redis`` c, Return a cached, process-wide async Redis client.      ``redis.asyncio.from_url`, FastAPI dependency wrapper around the cached async Redis client., Authentication business logic.
...
### Community 296 - "Development Workflow"
Cohesion: 0.17
Nodes (11): Context Loading, Definition of Done, Development Lifecycle, Development Workflow, Documentation Maintenance, Git Workflow, Graphify Workflow, Implementation Rules (+3 more)

### Community 297 - "Error Handling"
Cohesion: 0.17
...
### Community 298 - "File Conventions"
Cohesion: 0.17
...
### Community 301 - "Styling & Customization"
Cohesion: 0.17
...
### Community 302 - "6. Rendering Performance"
Cohesion: 0.17
...
### Community 303 - "Auth (`/api/v1/auth`) — `app/features/auth/`"
Cohesion: 0.18
Nodes (11): Auth (`/api/v1/auth`) — `app/features/auth/`, `GET /auth/me`, `GET /auth/oauth/{provider_name}/callback`, `GET /auth/oauth/{provider_name}/start`, `POST /auth/forgot-password`, `POST /auth/login`, `POST /auth/logout`, `POST /auth/register` (+3 more)

### Community 304 - "Font Optimization"
Cohesion: 0.18
...
### Community 306 - "3. Server-Side Performance"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (16): close_httpx_clients(), FastAPI, Centralized HTTP client management with connection pooling. Provides shared http, Close all shared clients gracefully.     Should be called on application shutdow, Set up FastAPI lifespan events to manage HTTP client lifecycle., setup_http_client_lifespan(), health_check(), lifespan() (+8 more)
...
Cohesion: 0.22
Nodes (4): WebSocket, Connection manager for realtime websocket clients., Tracks active websocket connections and broadcasts JSON payloads., RealtimeConnectionManager

### Community 311 - "Async Params and SearchParams"
Cohesion: 0.20
...
### Community 313 - "Common Causes and Fixes"
Cohesion: 0.20
...
### Community 314 - "Image Optimization"
Cohesion: 0.20
...
### Community 317 - "React Best Practices"
Cohesion: 0.20
...
Cohesion: 0.29
Nodes (4): IPControlStateService, AsyncSession, Business logic for authoritative current IP control state., Tracks the latest backend-confirmed state for each controlled IP.
...
### Community 323 - "Coding Standards"
Cohesion: 0.22
Nodes (8): Backend (FastAPI, `backend/`), Coding Standards, Documentation, Frontend (`frontend/`, TypeScript/Next.js), General, Packet capture / runtime (`packet_capture/`, `traffic_engine/`, `feature_engine/`, `ml/`, `threat_detection/`, `response_engine/`), Python, Testing

### Community 325 - "Base vs Radix"
Cohesion: 0.22
...
Cohesion: 0.22
Nodes (9): scripts, build, db:generate, db:migrate, db:seed, db:studio, dev, lint (+1 more)
...
Cohesion: 0.09
Nodes (22): Aggregations, Basic Aggregates, Basic Delete, Delete Operations, Delete with Returning, Delete with Subquery, Drizzle Query Patterns, Group By (+14 more)
...
Cohesion: 0.33
Nodes (3): LocationRepository, AsyncSession, AsyncSession
...
Cohesion: 0.33
Nodes (3): Business logic for threat reports., Provides threat report retrieval operations., ThreatService

### Community 337 - "Detection Rules"
Cohesion: 0.29
...
### Community 340 - "Joins"
Cohesion: 0.29
Nodes (7): Full Join, Inner Join, Join with Selected Columns, Joins, Left Join, Multiple Joins, Right Join

### Community 341 - "Critical Rules"
Cohesion: 0.29
...
### Community 342 - "1. Eliminating Waterfalls"
Cohesion: 0.29
...
### Community 343 - "2. Bundle Size Optimization"
Cohesion: 0.29
Nodes (7): 2.1 Avoid Barrel File Imports, 2.2 Conditional Module Loading, 2.3 Defer Non-Critical Third-Party Libraries, 2.4 Dynamic Imports for Heavy Components, 2.5 Prefer Statically Analyzable Paths, 2.6 Preload Based on User Intent, 2. Bundle Size Optimization

### Community 344 - "get_engine_service"
Cohesion: 0.33
Nodes (5): get_engine_service(), AsyncSession, Redis, FastAPI dependencies for the engines feature., Provide an EngineService instance for the current request.

### Community 345 - "RegisterInitRequest"
Cohesion: 0.33
Nodes (5): get_sync_httpx_client(), Client, Get or create the shared synchronous httpx.Client for sync contexts (Celery)., Celery task: resolve and persist an IP geolocation for a user session.  Retry po, resolve_session_location_task()

### Community 346 - "api_smoke_dashboard_metrics_ws.py"
Cohesion: 0.53
Nodes (5): _http_post_json(), main(), API smoke check for dashboard metrics websocket delivery.  Usage:   python backe, run(), _ws_url()

### Community 347 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 348 - "API Keys (`/api/v1/api-keys`) — `app/features/api_keys/`"
Cohesion: 0.33
Nodes (6): API Keys (`/api/v1/api-keys`) — `app/features/api_keys/`, `DELETE /api-keys/{api_key_id}`, `GET /api-keys`, `GET /api-keys/{api_key_id}`, `PATCH /api-keys/{api_key_id}`, `POST /api-keys`

### Community 349 - "Blocked IPs (`/api/v1/blocked-ips`) — `app/features/blocked_ips/`"
Cohesion: 0.33
Nodes (6): Blocked IPs (`/api/v1/blocked-ips`) — `app/features/blocked_ips/`, `DELETE /blocked-ips/{ip_address}`, `GET /blocked-ips`, `GET /blocked-ips/{ip_address}/activity`, `POST /blocked-ips`, `POST /blocked-ips/{ip_address}/watchlist`

### Community 350 - "Realtime (`/api/v1/realtime`) — `app/features/realtime/`"
Cohesion: 0.33
Nodes (6): `POST /realtime/broadcast`, `POST /realtime/broadcast/blocked-ips`, `POST /realtime/broadcast/dashboard`, `POST /realtime/broadcast/sessions`, Realtime (`/api/v1/realtime`) — `app/features/realtime/`, `WS /realtime/ws`

### Community 351 - "postgres-drizzle"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (3): Request body for verifying an email token., VerifyEmailRequest, VerifyEmailValidationTest
...
Cohesion: 0.33
Nodes (6): Basic Select, Comparison Operators, Conditional Filters, Pattern Matching, Select Queries, Where Clause

### Community 356 - "shadcn CLI Reference"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): Application, Indexing, Maintenance, Performance Checklist, PostgreSQL Configuration, Queries
...
### Community 360 - "get_threat_service"
Cohesion: 0.40
Nodes (4): get_threat_service(), AsyncSession, FastAPI dependencies for threat reports., Provide ThreatService for current request.

### Community 361 - "ThreatNotFoundException"
Cohesion: 0.40
Nodes (3): Threat report feature exceptions., Raised when a threat record cannot be found., ThreatNotFoundException

### Community 362 - "User Sessions (`/api/v1/auth/sessions`) — `app/features/user_sessions/`"
Cohesion: 0.40
Nodes (5): `DELETE /auth/sessions`, `DELETE /auth/sessions/others`, `DELETE /auth/sessions/{session_id}`, `GET /auth/sessions`, User Sessions (`/api/v1/auth/sessions`) — `app/features/user_sessions/`

### Community 363 - "Network Sessions (`/api/v1/sessions`) — `app/features/sessions/`"
Cohesion: 0.40
Nodes (5): `GET /sessions`, `GET /sessions/{session_id}`, Network Sessions (`/api/v1/sessions`) — `app/features/sessions/`, `POST /sessions/{session_id}/respond`, `POST /sessions/upsert`

### Community 364 - "Schema Definition"
Cohesion: 0.40
...
### Community 370 - "8. Advanced Patterns"
Cohesion: 0.40
...
### Community 371 - "get_realtime_service"
Cohesion: 0.50
Nodes (3): get_realtime_service(), Dependencies for realtime feature., Provide a RealtimeService instance.

### Community 372 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 373 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 374 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 375 - "Engine Commands (`/api/v1/engine-commands`) — `app/features/engine_commands/`"
Cohesion: 0.50
Nodes (4): Engine Commands (`/api/v1/engine-commands`) — `app/features/engine_commands/`, `GET /engine-commands`, `POST /engine-commands`, `POST /engine-commands/ack`

### Community 376 - "Threat Reports (`/api/v1/threats`) — `app/features/threats/`"
Cohesion: 0.50
...
### Community 377 - "Monitoring Queries"
Cohesion: 0.40
...
### Community 382 - "FakeEngineCommandService"
Cohesion: 0.60
Nodes (4): main(), Path, Runs unified reporting API smokes in sequence.  Covers: - ids-events + alerts sm, _run()

### Community 383 - "realtime_ws"
Cohesion: 0.67
Nodes (3): WebSocket, Register websocket client for server-driven alerts., realtime_ws()
...
Cohesion: 0.50
Nodes (3): get_block_event_service(), AsyncSession, Dependencies for block events feature.
...
- **Why does `create_response()` connect `backend/app/features/auth (n=33)` to `backend/app/features/realtime (n=63)`, `backend/app/features/threats (n=54)`, `backend/app/features/alerts (n=38)`, `backend/app/features/dashboard (n=35)`, `backend/app/features/auth (n=34)`, `backend/app/features/api keys (n=34)`, `router.py`, `backend/app/features/engine telemetry (n=24)`, `backend/app/features/ids events (n=24)`, `backend/app/features/sql injection (n=22)`, `CustomDecisionTreeClassifier`, `create_api_key`, `backend/app/features/engine commands (n=19)`, `backend/app/features/notifications (n=19)`, `list_threats`, `backend/app/features/blocked ips (n=11)`, `backend/app/features/sessions (n=11)`, `docs (n=1)`, `backend/app/features/sessions (n=9)`, `backend/app/features/block events (n=8)`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Settings` connect `backend/app/features/auth (n=39)` to `backend/app/features/auth (n=18)`, `RegisterInitRequest`, `backend/app/email (n=49)`, `backend/app/features/auth (n=10)`, `docs (n=1)`, `tests/unit (n=9)`, `backend/app/features/auth (n=33)`, `tests/unit (n=15)`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AuthService` connect `backend/app/features/auth (n=33)` to `get_internal_auth_redis`, `backend/app/features/auth (n=18)`, `backend/app/email (n=49)`, `backend/app/features/auth (n=10)`, `backend/app/features/auth (n=39)`, `docs (n=1)`, `tests/unit (n=21)`, `backend/app/features/auth (n=31)`?**
...
- **Are the 74 inferred relationships involving `create_response()` (e.g. with `list_alerts()` and `upsert_alert()`) actually correct?**
  _`create_response()` has 74 INFERRED edges - model-reasoned connections that need verification._
- **Are the 26 inferred relationships involving `InternalRequestSigner` (e.g. with `FastAPIAlertForwarder` and `FastAPIBlockEventForwarder`) actually correct?**
  _`InternalRequestSigner` has 26 INFERRED edges - model-reasoned connections that need verification._