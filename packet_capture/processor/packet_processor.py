    ...
    def _log_startup_status(self):
        ...
        log_event(
            ...
            "packet processor startup status",
            {
                ...
                "live_secondary_model_path": str(self.live_predictor.secondary_model_path),
                "live_secondary_encoder_path": str(self.live_predictor.secondary_encoder_path),
                "live_secondary_model_error": self.live_predictor.secondary_artifact_error,
                ...
                "completed_secondary_model_path": str(self.completed_flow_predictor.secondary_model_path),
                "completed_secondary_encoder_path": str(self.completed_flow_predictor.secondary_encoder_path),
                "completed_secondary_model_error": self.completed_flow_predictor.secondary_artifact_error,
