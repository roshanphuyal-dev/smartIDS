...
class ForgotPasswordValidationTest(unittest.TestCase):
    def test_forgot_password_request_accepts_valid_email(self) -> None:
        payload = ForgotPasswordRequest(email="forgot@example.com")

        self.assertEqual(payload.email, "forgot@example.com")
